...
<div class="content mar_20">
        ...
        <div class="l_list">
			<div class="brand_t">>标题:{{$content_data->title}}</div>
            <div class="list_c">
                    	<div class="text-center"><h1 style="color: red">{{$content_data->title}}</h1></div><br>
                    	<div class="text-right"><span>作者：{{$content_data->author}}&nbsp;发布时间：{{$content_data->created_at}}</span></div><hr>
                    	<div class="text-center">{!!$content_data->content!!}</div><br><br><br>
